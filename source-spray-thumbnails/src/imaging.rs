use crate::imaging::ThumbnailError::DecompressionError;
use crate::vtf::{ImageFormat, VtfData};
use image::imageops::FilterType;
use image::{GenericImageView, RgbaImage};
use std::cmp::max;
use std::iter::zip;
use std::ops::Deref;
use texture2ddecoder::{decode_bc1a, decode_bc3};
use thiserror::Error;
...
pub(crate) fn decode_to_image(
	...
	match format {
		ImageFormat::DXT1 => decode_bc1a(data, width as usize, height as usize, &mut out)?,
		ImageFormat::DXT5 => decode_bc3(data, width as usize, height as usize, &mut out)?,
	}
	...
	Ok(RgbaImage::from_raw_bgra(width, height, buffer).unwrap())
}
